      ...
      <div className="strategy-consulting-card">
        ...
        <div className="left-section">
          ...
          <div className="left-content">
            {/* Title */}
            <h2 className="main-title">Digital SEO olutions</h2>
        ...
        <div className="right-section">
          <div className="right-content">
            ...
            <div className="content-block">
              <h3 className="block-title">1. Intelligent AI Chatbots</h3>
              <div className="bullet-points">
                ...
                <div className="bullet-item">
                  <span className="bullet">•</span>
                  <span><strong></strong> We build fast, responsive websites optimized to convert traffic into sales. The AI chatbot acts as a seamless extension of your sales team, engaging visitors and turning them into qualified leads.

</span>
                </div>
                <div className="bullet-item">
                  <span className="bullet">•</span>
                  <span><strong>Scalable Architecture</strong> Our solutions are built to grow with your business, ensuring your website and AI agents can handle increasing traffic and data without compromising performance.
