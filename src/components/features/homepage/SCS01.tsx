...
const StrategyConsultingSection: React.FC<StrategyConsultingSectionProps> = ({
  ...
  return (
    <section className={`strategy-consulting-container ${className}`}>
      {/* HEADER SECTION - BORDER REMOVED, SPACING REDUCED */}
      <div className="above-border-section">
      ...
      <div className="strategy-consulting-card">
        ...
        <div className="left-section">
          ...
          <div className="left-content">
            ...
            {/* Learn More Button */}
            <button className="learn-more-btn" onClick={handleLearnMoreClick}> {/* Add onClick */}
        ...
        <div className="right-section">
          <div className="right-content">
            ...
            <div className="content-block">
              <h3 className="block-title">1. Strategic AI Process Design</h3>
