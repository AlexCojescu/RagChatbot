      ...
      <div className="strategy-consulting-card">
        ...
        <div className="left-section">
          ...
          <div className="left-content">
            {/* Title */}
            <h2 className="main-title">Intelligent RAG Infrastructure</h2>

            {/* Subtitle */}
            <h3 className="subtitle">Unlock Verified Data. Accelerate AI Decisions. Drive Strategic Advantage.</h3>
        ...
        <div className="right-section">
          <div className="right-content">
            ...
            <div className="content-block">
              <h3 className="block-title">1. Strategic Data Engineering & Optimized Retrieval Design</h3>
            ...
            {/* Second Section */}
            <div className="content-block">
              <h3 className="block-title">2. Fortified LLM Integration & Resilient Orchestration</h3>
              <div className="bullet-points">
                <div className="bullet-item">
                  <span className="bullet">•</span>
