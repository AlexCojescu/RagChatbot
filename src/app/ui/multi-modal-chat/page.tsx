//has an attach files capability. the image pops up and the ai responds to your question based off the image. it can analyze the image and give you a specific description of anyhting.
//model can see and understand image content, review entire long documents
